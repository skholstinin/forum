...
import ru.testtask.security.model.Roles;
import ru.testtask.security.model.WebUserDetails;
...
public final class SecurityUtils {
    ...
    public static boolean isAdmin() {
        return Roles.ROLE_ADMIN.equals(getAuthenticatedRole());
    }
